...
ALLOWED_ASSET_EXTENSIONS = {'.png', '.jpg', '.jpeg', '.gif', '.png', '.svg',
...
def get_assets():
    return [f for f in sorted(os.listdir(ASSETS_DIR)) if f.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.png'))]
...
def assets_list():
    ...
    img_exts  = {'.png', '.jpg', '.jpeg', '.gif', '.png', '.svg'}
    ...
    <script>
        ...
        // View switcher
        var IMG_EXTS  = new Set(['.png','.jpg','.jpeg','.gif','.png','.svg']);
